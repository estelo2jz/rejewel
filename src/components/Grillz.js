  ...
  return (
    <div className="para-container">
      <div className="image para-quote">
        ...
        <p onClick={() => props.addBasket('S505')} className="addToCart cart1">
      ...
      <div className="image para-quote">
        ...
        <p onClick={() => props.addBasket('S161506')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image para-quote">
        ...
        <p onClick={() => props.addBasket('JDG73')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image para-quote">
        ...
        <p onClick={() => props.addBasket('JDG65')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image para-quote">
      ...
      <div className="image para-quote">
        ...
        <p onClick={() => props.addBasket('S2530032')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image para-quote">
        ...
        <p onClick={() => props.addBasket('S105B')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image para-quote">
        ...
        <h3 className="jewel-price">$4,000,00</h3>
        <p onClick={() => props.addBasket('C1532')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image para-quote">
        ...
        <p onClick={() => props.addBasket('JDG69')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image para-quote">
        ...
        <p onClick={() => props.addBasket('JDG36')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image para-quote">
        ...
        <p onClick={() => props.addBasket('JDG32')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image para-quote">
        ...
        <p onClick={() => props.addBasket('JD103')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image para-quote">
        ...
        <h3 className="jewel-price">$7,800,00</h3>
        <p onClick={() => props.addBasket('JD102')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image para-quote">
        ...
        <p onClick={() => props.addBasket('JD101')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
    </div>
...
export default connect(null, { addBasket })(Grillz);