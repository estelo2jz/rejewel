  ...
  return (
    <div className="para-container">
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW0001')} className="addToCart cart1">
      ...
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW0002')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW0003')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW0004')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW0005')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <h3 className="jewel-price">$12,000,00</h3>
        <p onClick={() => props.addBasket('CW0006')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW0007')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW0008')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <h3 className="jewel-price">$9,000,00</h3>
        <p onClick={() => props.addBasket('CW0009')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW00010')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW00011')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <h3 className="jewel-price">$22,990,00</h3>
        <p onClick={() => props.addBasket('CW00012')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW00013')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW00014')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW00015')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <h3 className="jewel-price">$16,940,00</h3>
        <p onClick={() => props.addBasket('CW00016')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW00017')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW00018')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('CW00019')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>
      </div>
    </div>
