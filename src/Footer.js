    ...
    return (
      <footer className="footer">
        <div className="container">
          <NavLink className="footer__logo" href="/#">
          ...
          <div className="footer__social">
            ...
            <NavLink href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer">
            ...
            <NavLink href="https://twitter.com/home" target="_blank" rel="noopener noreferrer">
            ...
            <NavLink href="https://www.pinterest.com/?autologin=true" target="_blank" rel="noopener noreferrer">
          ...
          <div className="footer__links col2">
            <NavLink href="/carrers">Careers</NavLink>
            <NavLink href="/support">Support</NavLink>
            <NavLink href="/privacy">Privacy Policy</NavLink>
          </div>
      
          <div className="footer__cta">
            <NavLink href="/contact" className="button">Request Custom</NavLink>
          </div>
